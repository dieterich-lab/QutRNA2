...
* Filter Adapter overlap: keep only reads whose alignment sufficiently spans the 5' and 3' splint adapters
* Filter multimapping reads: remove reads with more than one reported alignment
